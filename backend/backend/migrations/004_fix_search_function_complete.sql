...
CREATE OR REPLACE FUNCTION search_hotels_smart(
    ...
    max_price_param NUMERIC DEFAULT NULL,  -- Mudei o nome para evitar conflito
...
BEGIN
    ...
    available_hotels AS (
        ...
        WHERE h.is_active = true
          ...
          AND (max_price_param IS NULL OR ras.min_price <= max_price_param)  -- Use o parâmetro renomeado
